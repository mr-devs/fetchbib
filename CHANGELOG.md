...
- `--print-config` flag to display current configuration settings

### Fixed

- Guard against OpenAlex non-object responses to prevent crashes
- Hardened core functionality against crashes and silent failures
